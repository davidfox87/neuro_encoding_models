...
if __name__ == "__main__":
	...
	output = open('../results/stim_to_spiking_filters/glmpars_vm_to_spiking_PN' + str(cell_idx) + '.pkl', 'wb')
	...
	wmap = mapfit_GLM(wmap, stim_basis.nbases, X_train, y_train, lamvals[imin]*Cinv, 1)
